...
namespace KioskData
{
    internal class RetrieveAverageRatingForPerson : DataReaderDelegate<IReadOnlyList<Rating>>
    {
        public RetrieveAverageRatingForPerson() : base("Kiosk.RetrieveAverageRatingForPerson") { }
