...
namespace KioskData
{
    internal class RetrieveAverageRatingForPlace : DataReaderDelegate<IReadOnlyList<Rating>>
    {
        public RetrieveAverageRatingForPlace() : base("Kiosk.RetrieveAverageRatingForPlace") { }
